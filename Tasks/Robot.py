...
""")
        f1.close()
        if os.path.exists('task.py'):
            print("Был создан файл task.py - запустите его")
        else:
            print("""Не удалось создать task.py. Попробуйте создать его самостоятельно с таким содержанием:
